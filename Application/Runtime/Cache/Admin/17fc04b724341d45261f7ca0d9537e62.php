...
<div class="well">
<div class="addform">
	<form id="addform" action="<?php echo U('Setting/setMsg');?>" method="post" enctype="multipart/form-data" target="exec_target">
		<label>网站标题</label>
		<input type="text" name="webtitle" value="<?php echo ($webinfo["webtitle"]); ?>"><d class="tishi webtitle"></d>
		<label>网站关键字</label>
		<input type="text" name="webkey" value="<?php echo ($webinfo["webkey"]); ?>"><d class="tishi webkey"></d>
		<label>网站描述</label>
		<input type="text" name="webdes" value="<?php echo ($webinfo["webdes"]); ?>"><d class="tishi webdes"></d>
		<label>Logo</label>
		<img src="<?php echo C('FILE_PATH'); echo ($webinfo["logo"]); ?>"><br/>
		<input type="file" name="logo"><d class="tishi logo"></d>
		<label>备案信息</label>
		<input type="text" name="rcopy" value="<?php echo ($webinfo["rcopy"]); ?>"><d class="tishi rcopy"></d><br/>
