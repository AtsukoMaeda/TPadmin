...
<div class="ajaxback">
    <table class="table table-bordered">
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="data">
...
<script>
  function mypage(nu){
   $.get("<?php echo U('Log/logList');?>",{'p':nu},function(back){
    $('.ajaxback').html(back);
   });
  }
</script>
